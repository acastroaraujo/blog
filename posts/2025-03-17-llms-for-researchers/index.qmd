...
2.  Tokenization.
    ...
    For example, lets turn the following phrase into a sequence of tokens:
    ...
    *Note. This is technically known as a Byte Pair Encoding (BPE) Tokenizer.*[^2]
...
1.  Train a neural network.
    ...
    See @jurafsky [Chapter 9] and this [3Blue1Brown video](https://youtu.be/eMlx5fFNoYc?feature=shared) for more information on "self-attention" and "multi-head attention" mechanisms that turn neural networks into "transformers."
