...
The strong overlap between [Cultural Sociology]{.allcaps} and so-called [Theory]{.allcaps} deserves its own blog post.
...
Also, note that [Quantitative Methodology]{.allcaps} now appears connected to three areas ([Stratification/ Mobility]{.allcaps}, [Demography]{.allcaps}, and [Mathematical Sociology]{.allcaps}), but [Qualitative Methodology]{.allcaps} is nowhere to be seen yet. This does *not* mean that one is more important than the other. It just means that the overlap between [Quantitative Methodology]{.allcaps} and those three areas is stronger than what we would expect by chance; whereas the overlap between [Qualitative Methodology]{.allcaps} and other areas is more compatible with a "null model" of random ties between areas.[^4]
