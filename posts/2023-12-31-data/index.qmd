...
When we think about "data" we generally think about *standardized* *data*---i.e., symbols that are arranged in a way that's convenient for computer processing. We think about symbols that are stable, manipulable, and transportable---or what Bruno Latour [-@latour1987] awkwardly calls "immutable and combinable mobiles."
