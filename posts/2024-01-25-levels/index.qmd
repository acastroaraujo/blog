...
These metaphors are too basic to how we organize the world. Scientists use them all the time. Rejecting these metaphors just because some obscure sociologist made poor use of them is laughable. So the word "level" may be inevitable, but it is also vague and invites confusion.
...
-   The [representation and algorithm]{.allcaps} level.
    ...
    Information-processing systems must represent their inputs and outputs in accordance to some form of formal scheme.[^3] This is important because "any particular representation makes certain information explicit at the expense of information that is pushed into the background and may be quite hard to recover" [@marr1982, pp. 60].
...
Source: David Marr [-@marr1982, pp. 64]
