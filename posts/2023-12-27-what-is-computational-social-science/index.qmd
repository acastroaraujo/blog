...
What exactly *is* a "data scientist"? No one knows exactly. But companies are hiring and universities are providing legitimacy via publications and newly minted masters programs [@spector2022; @donoho2017].[^3]
...
This kind of influence via metaphor can be found in cybernetics, where ideas developed to predict the location of enemy planes---the idea of goal-directedness as control over perturbations---were used to study all sorts of technical, biological, and social systems [@galison1994]. A similar influence can be found in the analogy between "cognitive systems" and "digital computers" at the center of cognitive science.

At the moment, computational social scientists seem to be focusing too much on methods and sources of data. But perhaps the future will provide with similar kinds of theoretical influences.[^5]

[^5]: Two examples come to mind. The idea that we should pay more attention to the algorithmic component of small-world networks [@kleinberg2000] and the idea that we

I see only a few theoretical influences. For example, the idea that we should pay more attention to the algorithmic component of small-world networks [@kleinberg2000]. Or maybe we should consider word embeddings as providing a template for cultural learning [@arseniev-koehler2022; cf. @landauer1997].

**Cybernetics or Cognitive Science?**

Unsurprisingly, many have described cognitive science as a powerful role model for CSS [e.g., @lazer2009]. But perhaps we might end up like cybernetics---i.e., very influential, still relevant, largely forgotten, and with every good thing about it absorbed into nearby disciplines that are no longer involved in trade.
