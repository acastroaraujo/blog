...
2.  *Information-processing.*
    ...
    We *hear* some spoken message, we *smell* something. We then react quickly, perhaps unconsciously, on the basis of some habitual way of seeing things that is grounded in personal experience.

    Following @goldberg, this means that we [interpret]{.smallcaps} a stimulus through [categorization]{.smallcaps} and [association]{.smallcaps}. Is that *thing* a bird? Is it a plane? That's [categorization]{.smallcaps} [@rosch1975]. The bird can in turn elicit all sort of "connected" concepts, such as food, disease, sacred, dinosaur, and so on. That's [semantic association]{.smallcaps}.[^1]
