...
2.  *Information-processing.*
    ...
    This means that we [interpret]{.smallcaps} a stimulus through [categorization]{.smallcaps} and [association \[]{.smallcaps}@goldberg[\]]{.smallcaps}. Is that *thing* a bird? Is it a plane? That's [categorization]{.smallcaps} [@rosch1975]. In turn, the bird can elicit all sort of "connected" concepts, such as food, disease, sacred, dinosaur, and so on. That's [semantic association]{.smallcaps}.[^1]
