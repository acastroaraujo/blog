...
The idea of [meaning-making]{.smallcaps} is somehow *more* ambiguous than the concept of [culture]{.smallcaps}. It cannot be the center of gravity for an entire subfield and we should really consider getting rid of it altogether.

In the meantime this how I have to come to make sense of [meaning-making]{.smallcaps}.
...
2.  *Information-processing.*
    ...
    We *hear* some spoken message, we *smell* something. We then react quickly, perhaps unconsciously, on the basis of some habitual way of seeing things that is grounded in personal experience. In other words, we [interpret]{.smallcaps} a stimulus via [categorization]{.smallcaps} and [association]{.smallcaps} [@goldberg2024].
...
[^2]: See @mills1940, @scott1968, @swidler1986, @vaisey2009, @small2021, and so on.

*Note. The meaning-as-motive approach should not be deny the importance of "habits" or "unawareness." Motives do not have to operate consciously to be causal [@vaisey2009].*
...
*If you combine information-processing and meaning-as-motive you end up with a modern rendition of Max Weber's [-@weber1978] interpretative sociology. This should be the actual "center of gravity" for cultural sociologists.*
