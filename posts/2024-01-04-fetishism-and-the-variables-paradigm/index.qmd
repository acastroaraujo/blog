...
-   They ignore that social activity is located space and time, unlike the always sophisticated Chicago School [@abbott1997].

-   *They are* *plain silly*. For example, they actually believe that some disembodied form of [education]{.allcaps} acts on another disembodied form of [occupation]{.allcaps}.

    They don't see individuals as *motivated* *actors*, but merely as the locale for the variables "doing their thing" [@abbott2001, pp. 132]!
