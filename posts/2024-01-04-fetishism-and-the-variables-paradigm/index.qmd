...
Karl Marx's criticism of commodity fetishism is very similar to Andrew Abbott's criticism of the so-called "variables-based approach" in sociology, which encompasses most standard quantitative research.
...
-   This kind of criticism exhibits an "unmasking style" which I find to be deeply immature [cf. @baehr2019].
    ...
    See: Plato's Cave; Marxist false consciousness; that famous red pill scene from The Matrix; etc.
...
-   The critic (or "critical thinker") is in a unique position to expose some widespread delusion and show that what "normal" people believe to be true is in reality false.
    ...
    This ambition is deeply ingrained in the discipline. It is our exposé tradition. "The first wisdom of sociology" according to Peter Berger is that "things are not what they seem."[^1]
...
-   This is related to what Kieran calls the *nuance of the connoisseur.*
...
But, I assure you, *no one out there really thinks that variables "cause" other variables in some social vacuum.*

## On Trained Incapacities

*Note. I added this section after receiving some useful feedback from friends. The main comment I received is some amount of skepticism—"I think it's true that many social scientists reify the categories used in a regression." Furthermore, many network researchers—or "network imperialists" as some great people here at Duke like to call themselves—say pretty much the same thing, that all individual characteristics (age, gender, education) are reductive proxies for the webs of social relations that ultimately matter.*

Anyways, here is a more charitable view of Andrew Abbott's full-blown attack on linear regression:
...
-   A similar thing happens when we want to answer questions for which spatial context is important. But this is why there's a whole subfield in statistics dedicated to modeling "spatial data."
...
-   Paul Pierson has a great culinary analogy for how time "works" in linear regression for cross-sectional data:
    ...
    But quantitative research does not *have* to be decontextualized in this way. There are many ways of adapting quantitative research to answer *some* of the criticisms levied by scholars like Pierson and Abbott [e.g., @wawro2022]. Thinking about temporal assumptions in linear regression can be very helpful, and so many quantitative researchers actually devote significant time to this.[^3]

    However, there is only one reasonable way of answering to someone accusing you of being an unsophisticated fool with weird metaphysics. You don't.
...
-   Specializing in quantitative methods produces a sort of "trained incapacity," limiting the scope of questions that researchers can answer. People that specialize in qualitative methods are *usually* not experts in quantitative research; people that specialize in social network analysis are *usually* not experts in archival research; and so on.
    ...
    *Sociology is actually better than most other disciplines at producing researchers that defy these expectations (e.g., Mario Small, Emily Erikson, Peter Bearman).*

[^3]: For example, did you know that fixed-effect models produce wrong estimates when the "causal lags in the real world do not match the lags found in panel data"? [@vaisey2017].
