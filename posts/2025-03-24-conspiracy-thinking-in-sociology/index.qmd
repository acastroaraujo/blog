---
title: "Conspiracy and Teleology"
description: |
...
1.  Sociology has a conspiracy thinking problem in the way we market ourselves to undergraduates. A little bit.
...
2.  Many influential arguments against "functionalism"—teleological explanations, to be more precise—were really arguments against conspiracy theories and "just-so stories" [e.g., @gould1979; @elster1983].
...
Briefly, a teleological explanation seeks to explain the presence, shape, or behavior of some phenomena by making reference to its [purpose]{.smallcaps} [@ruse2017; @tugby2024]. This is a style of explanation that goes all the way back to Aristotle's discussions of "final cause" [@leunissen2010]. Less ambiguous forms of teleological explanation whenever people replace the word "purpose" with either [function]{.smallcaps} or [goal]{.smallcaps}, which still carry the connotation that there is some form of "design" lying in the background, whether intentional or not.

Biologists don't like to talk about [purpose]{.smallcaps}, since it implies some form of "intelligent design." But Charles Darwin made [purpose]{.smallcaps} safe for biologists by transforming it into the blind mechanistic process known as natural selection.[^2] Social scientists, however, cannot do without intentionality. Our world is filled with designers of all sorts in pursuit of their own goals, interests, and values. We wrote TFP because we cannot get rid of teleological explanations.

[^2]: The idea of "teleology without intention" sometimes goes by awkward term of [teleonomy]{.smallcaps}. Google it.
...
<aside><https://en.wikipedia.org/wiki/Adaptationism></aside>
...
Natalie ends her video ([02:23:21](https://youtu.be/teqkK0RLNkI?feature=shared&t=8602)) with some speculations about *why* conspiracy thinking is so attractive. The idea is that we may all share a psychological predisposition to “make sense” of unintended or accidental phenomena; in this case, attributing “meaning” to something means attributing [purpose]{.smallcaps} to it.
...
Maybe it is. Or maybe it points to an important research question that deserves further scrutiny. Regardless, teleological explanations seem unavoidable. We should at least try and do a good job.

I recommend [[the functionalism paper]{.smallcaps}](https://osf.io/preprints/socarxiv/dfc4k).